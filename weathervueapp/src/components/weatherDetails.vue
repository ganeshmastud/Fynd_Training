<template>
    ...
    <div clas="d-flex  justify-content-center flex-row">
        ...
        <div class=" d-flex col-4 mx-auto mt-3  justify-content-center flex-column">
            <div class="shadow-sm bg-light box weather-container col-12 pt-3 pb-3 mb-3 d-flex flex-row " v-for="weather,idx in getAllCities" :key="idx">
            <!-- {{weather.icon}} -->
                <div class="icon col-4">
                    <img class="icon-img" :src="weather.icon" :alt="weather.icon">
                </div>
                <div class="weather-detail col-8 ">
                    <img class="bg-img" :src="require(weather.imgpath)" width="100px" height="100px" :alt="weather.imgpath">
                    <div class="sub-cntr clearfix">
                        ...
                        <span class="min-temp"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
                                </svg>
                                {{weather.min_temp}} &deg; <span class="celcius">C</span></span>
                        <span class="max-temp"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
